...
# only latest
moddirs23 <- moddirs[grep("1980-2024", moddirs, invert = TRUE)]
```
...
```{r, fig.height=8}
macrobenall_stn <- readRDS(here::here("benthos/fhdata/macrobenall_stn.rds"))
...
load(here::here("benthos/data/prey.RData")) #original mappings from June 2023
...
```{r, fig.height=8}
megabenall_stn <- readRDS(here::here("benthos/fhdata/megabenall_stn.rds"))
